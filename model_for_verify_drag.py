...
plt.figure(1)
plt.plot(lengths, drags[:, 0], label='dragTot')
plt.plot(lengths, drags[:, 1], label='skinDrag')
plt.plot(lengths, drags[:, 2], label='cdBeta')
plt.plot(lengths, drags[:, 3], label='cdBase')
plt.plot(lengths, drags[:, 4], label='htpDrag')
plt.plot(lengths, drags[:, 5], label='vtpDrag')
plt.legend()
...
plt.figure(2)
plt.plot(angs, drags[:, 0], label='dragTot')
plt.plot(angs, drags[:, 1], label='skinDrag')
plt.plot(angs, drags[:, 2], label='cdBeta')
plt.plot(angs, drags[:, 3], label='cdBase')
plt.plot(angs, drags[:, 4], label='htpDrag')
plt.plot(angs, drags[:, 5], label='vtpDrag')
plt.legend()
